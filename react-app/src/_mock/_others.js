...
// ----------------------------------------------------------------------
export const _memberList = [
  {
    id: 3,
    name: 'Von John Bautista',
    role: 'Developer',
    avatarUrl: '/app/assets/vvvv.jpg',
  },
  {
    id: 1,
    name: 'Aidrain Alcantara',
    role: 'Developer',
    avatarUrl: '/app/assets/bok.jpg',
  },
  {
    id: 2,
    name: 'Jon Alavarez',
    role: 'Developer',
    avatarUrl: '/app/assets/jonny.png',
  },
  {
    id: 3,
    name: 'Von John Bautista',
...
// export const _memberList = [...Array(1)].map((_, index) => ({
//   id: _memberListRaw.id(index),
//   name: _memberListRaw.fullName(index),
//   role: _memberListRaw.role(index),
//   avatarUrl: _memberListRaw.image.portrait(index),
// }));
